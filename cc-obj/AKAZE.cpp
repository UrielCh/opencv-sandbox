...
Napi::Object AKAZEWrapper::Init(Napi::Env env, Napi::Object exports) {
    ...
    Napi::Function ctor = DefineClass(env, "AKAZE", {
        InstanceMethod<&AKAZEWrapper::getDefaultName>("getDefaultName", atts),
        // InstanceMethod("getDefaultName", &AKAZEWrapper::getDefaultName),
        InstanceMethod("getDescriptorSize", &AKAZEWrapper::getDescriptorSize),
        InstanceMethod("getDescriptorType", &AKAZEWrapper::getDescriptorType),
        InstanceMethod("setDescriptorSize", &AKAZEWrapper::setDescriptorSize),
        InstanceMethod("setDescriptorType", &AKAZEWrapper::setDescriptorType),
        InstanceMethod("setThreshold", &AKAZEWrapper::setThreshold),
        InstanceMethod("setNOctaves", &AKAZEWrapper::setNOctaves),
        InstanceMethod("setNOctaveLayers", &AKAZEWrapper::setNOctaveLayers),
        InstanceMethod("setDescriptorChannels", &AKAZEWrapper::setDescriptorChannels),
        InstanceMethod("setDiffusivity", &AKAZEWrapper::setDiffusivity),
        InstanceMethod("getNOctaves", &AKAZEWrapper::getNOctaves),
        InstanceMethod("getThreshold", &AKAZEWrapper::getThreshold),
        InstanceMethod("getDescriptorSize", &AKAZEWrapper::getDescriptorSize),
        InstanceMethod("getDiffusivity", &AKAZEWrapper::getDiffusivity),
        InstanceMethod("getNOctaveLayers", &AKAZEWrapper::getNOctaveLayers),
        InstanceMethod("getDescriptorChannels", &AKAZEWrapper::getDescriptorChannels),
    ...
    exports.Set("AKAZE", ctor);
    return exports;
}

AKAZEWrapper::AKAZEWrapper(const Napi::CallbackInfo &info)
    : Napi::ObjectWrap<AKAZEWrapper>(info) {
    akaze_ = cv::AKAZE::create();  // new AKAZE();
}

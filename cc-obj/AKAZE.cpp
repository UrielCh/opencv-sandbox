...
// all types should be in a separate file
...
// Static methods named as ${name}Static
...
Napi::Object AKAZEWrapper::Init(Napi::Env env, Napi::Object exports) {
    ...
    Napi::Function func = DefineClass(env, "AKAZE", {
                                                        // properties
                                                        // InstanceAccessor<&AKAZEWrapper::get_offset>("offset"), // readonly
                                                        // InstanceAccessor<&AKAZEWrapper::get_offset, &AKAZEWrapper::set_offset>("offset"), // read/write
                                                        // methods
